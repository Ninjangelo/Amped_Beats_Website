...
<nav class="navbar navbar-dark navbar-expand-md bg-dark py-3" action="customer_dashboard.php" method="post">
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-grid">
            <a href="admin_manage_account.php" class="dashboard-block">Manage Accounts</a>
            <a href="admin_manage_booking.php" class="dashboard-block">Manage Booking</a>
            <a href="admin_review_summary.php" class="dashboard-block">Review Summary</a>
        </div>
    </div>
</body>
</html>
