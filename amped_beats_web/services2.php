...
<head>
    ...
    <!-- Website Tab Title -->
    <title>Event Types | Amped Beats</title>
...
<?php
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4">Event Types</h1>
        <div class="row">
            <div class="col-md-3">
                <div class="card">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="media/kid.jpg" class="card-img-top" alt="Kids">
                    <div class="card-body">
                        <h6 class="card-title">Kids Parties</h6>
                        <p class="card-text">Ever have trouble wondering what to do as a parent? Try out our kids parties, to entertain the younger guests</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <img src="media/prom.jpg" class="card-img-top" alt="Prom">
                    <div class="card-body">
                        <h6 class="card-title">Prom</h6>
                        <p class="card-text">Gotta treat your date from school? Well look no further, as we have prom selections among us.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <img src="media/concert.jpg" class="card-img-top" alt="Concert">
                    <div class="card-body">
                        <h6 class="card-title">Concert</h6>
                        <p class="card-text">A big concert needs a DJ to give the audience a hype to live upto, so give us a try.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <img src="media/bar_mitzvah.jpg" class="card-img-top" alt="Bar Mitzvah">
                    <div class="card-body">
                        <h6 class="card-title">Bar Mitzvah</h6>
                        <p class="card-text">The age of adulthood for those in the Jewish faith, so best way is to celebrate with out of our DJs</p>
                    </div>
                </div>
            </div>
        </div>
