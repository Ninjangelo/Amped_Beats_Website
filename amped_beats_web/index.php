...
<body>
    ...
    <div id="videoContainer">
        ...
        <div id="videoButtons">
            <a role="button" href="register.php">Book Today!</a>
            <a role="button" href="services.php">Event Types</a>
        </div>
    </div>
    <div id="infoContainer1">

        <h1 id="h1">Are you a DJ jump-starting your Career?</h1>
            <a id="a" role="button" href="register_dj.php">Sign Up Today!</a>
    </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Genre: HipHop</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
