...
<body>
  <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3" id="navigation">
    <div class="container">
...
<div id="section1">
        <div id="userSelectionBlock">
            <h1>Login</h1>
            <div id="buttonBlock">
                <a class="userSelectionButton" role="button" href="login_customer.php">Customer</a>
                <a class="userSelectionButton" role="button" href="login_dj.php">DJ</a>
            </div>
        </div>
    </div>
</body> 
